...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Squamish1Review', function() {
      beforeEach(function() {
        instance = new BrcApi.Squamish1Review();
      });

      it('should create an instance of Squamish1Review', function() {
        // TODO: update the code to test Squamish1Review
        expect(instance).to.be.a(BrcApi.Squamish1Review);
      });
      ...
      it('should have the property cleanAndRappel (base name: "clean_and_rappel")', function() {
        // TODO: update the code to test the property cleanAndRappel
        expect(instance).to.have.property('cleanAndRappel');
        // expect(instance.cleanAndRappel).to.be(expectedValueLiteral);
      });
