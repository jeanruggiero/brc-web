...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Squamish2Review', function() {
      beforeEach(function() {
        instance = new BrcApi.Squamish2Review();
      });

      it('should create an instance of Squamish2Review', function() {
        // TODO: update the code to test Squamish2Review
        expect(instance).to.be.a(BrcApi.Squamish2Review);
      });
      ...
      it('should have the property squamish2Transitions (base name: "squamish2_transitions")', function() {
        // TODO: update the code to test the property squamish2Transitions
        expect(instance).to.have.property('squamish2Transitions');
        // expect(instance.squamish2Transitions).to.be(expectedValueLiteral);
      });

      it('should have the property squamish2Communication (base name: "squamish2_communication")', function() {
        // TODO: update the code to test the property squamish2Communication
        expect(instance).to.have.property('squamish2Communication');
        // expect(instance.squamish2Communication).to.be(expectedValueLiteral);
      });
