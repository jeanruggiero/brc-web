...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GradClimbReview', function() {
      beforeEach(function() {
        instance = new BrcApi.GradClimbReview();
      });

      it('should create an instance of GradClimbReview', function() {
        // TODO: update the code to test GradClimbReview
        expect(instance).to.be.a(BrcApi.GradClimbReview);
      });
      ...
      it('should have the property tripPlanning (base name: "trip_planning")', function() {
        // TODO: update the code to test the property tripPlanning
        expect(instance).to.have.property('tripPlanning');
        // expect(instance.tripPlanning).to.be(expectedValueLiteral);
      });

      it('should have the property betaSheet (base name: "beta_sheet")', function() {
        // TODO: update the code to test the property betaSheet
        expect(instance).to.have.property('betaSheet');
        // expect(instance.betaSheet).to.be(expectedValueLiteral);
      });

      it('should have the property transitions (base name: "transitions")', function() {
        // TODO: update the code to test the property transitions
        expect(instance).to.have.property('transitions');
        // expect(instance.transitions).to.be(expectedValueLiteral);
      });
